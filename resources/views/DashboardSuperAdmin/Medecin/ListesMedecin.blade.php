        ...
        <div
            ...
            <div class="items-center justify-between lg:flex">
                <div class="mb-4 lg:mb-0">
                    <h3 class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Doctor</h3>
                    <span class="text-base font-normal text-gray-500 dark:text-gray-400">This is a list of Doctor
                    </span>
                </div>
                                        ...
                                        <tr class="bg-gray-50 dark:bg-gray-700">
                                            ...
                                            <td class="p-4 text-sm font-normal whitespace-nowrap">
                                                @if ($medecin->etat == 'verifier')
                                                    <span
                                                        class="bg-green-100 text-white-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-green-400 border border-green-100 dark:border-green-500">{{ $medecin->etat }}</span>
                                                @else
                                                    <span
                                                        class="bg-red-100 text-white-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-red-400 border border-red-100 dark:border-red-500">{{ $medecin->etat }}</span>
                                                @endif
                                            </td>
                                            <td class="p-4 text-sm font-normal whitespace-nowrap">
                                                @if ($medecin->statut == 'connecter')
                                                    <span
                                            ...
                                            <td class="p-4 whitespace-nowrap">
                                                <button
                                                    ...
                                                    style="background-color: #0e54b7; color: white;">
                                                    <a href="{{ route('medecin_super_admin.show', $medecin->id) }}"
                                                        class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-600"
                                                        style="color: inherit; text-decoration: none;">
                                                        View Details
                                                    </a>
                                                </button>
                                                {{-- {{ route('medecin_super_admin.show', $medecin->id) }} --}}
                                            </td>
