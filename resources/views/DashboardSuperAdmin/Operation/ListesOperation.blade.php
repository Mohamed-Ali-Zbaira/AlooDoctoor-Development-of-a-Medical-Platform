    ...
    <div
        ...
        <div class="w-full mb-1"><br>
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All Operations</h1>
            </div>
            <div class="sm:flex">
                <div
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                        <img class="w-10 h-10 rounded-full"
                                            src="{{ asset('uploads') }}/{{ asset($O->image) }}" alt="Neil Sims avatar">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button" data-modal-toggle="#edit-user-modal{{ $O->id }}"
                                        ...
                                        <!-- Delete button -->
                                        <button type="button" data-modal-toggle="#delete-user-modal{{ $O->id }}"
                                            data-id="{{ $O->id }}"
                        ...
                        <form action="{{ route('operations.update', ['id' => $O->id]) }}" method="POST"
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="nom" value="{{ $O->nom }}" id="nom"
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="etablissement_medical"
                                        value="{{ $O->etablissement_medical }}" id="etablissement_medical"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="numero_chambre"
                                        ...
                                        Chambre</label>
                                    <input type="number" name="numero_chambre" value="{{ $O->numero_chambre }}"
                                        id="numero_chambre"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                </div>
    ...
    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
        ...
        <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <!-- Modal body -->
                <div class="p-6 space-y-6">
                    <form method="POST" action="{{ route('operationsDash.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="ville" id="ville"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Ville de l'opération" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="tarifs"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tarifs</label>
                                <input type="number" name="tarifs" id="tarifs"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Tarifs de l'opération" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="date"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date</label>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="duree" id="duree"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Durée de l'opération" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="medecin"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Médecin</label>
                                <input type="text" name="medecin" id="medecin"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Médecin de l'opération" required>
                            </div>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="etablissement_medical"
                                    ...
                                    médical</label>
                                <input type="text" name="etablissement_medical" id="etablissement_medical"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Établissement médical de l'opération" required>
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="numero_chambre"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Numéro de
                                ...
                                <input type="number" name="numero_chambre" id="numero_chambre"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Numéro de chambre" required>
                            </div>
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <div class="p-6 pt-0 text-center">
                        ...
                        <h3 class="mt-5 mb-6 text-lg text-gray-500 dark:text-gray-400">
                            ...
                            delete this user?</h3>
                        <a href="/dashboardSuperAdmin/ListesOperations/{{ $O->id }}"
