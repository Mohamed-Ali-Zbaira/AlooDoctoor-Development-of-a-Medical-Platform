                            ...
                            @foreach ($cliniques as $clinique => $C)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <button type="button" data-modal-toggle="#edit-user-modal{{ $C->id }}"
                                        ...
                                        <!-- Delete button -->
                                        <button type="button" data-modal-toggle="#delete-user-modal{{ $C->id }}"
                                            data-id="{{ $C->id }}"
            ...
            <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <div class="p-6 space-y-6">
                        <form action="{{ route('cliniques.update', ['clinique' => $C->id]) }}" method="POST"
    ...
    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
        ...
        <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <!-- Modal body -->
                <div class="p-6 space-y-6">
                    <form action="{{ route('cliniques.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                            <button
                                class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                                type="submit">Ajouter Clinique </button>
                        </div>
                    </form>
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                    ...
                    <div class="p-6 pt-0 text-center">
                        ...
                        <h3 class="mt-5 mb-6 text-lg text-gray-500 dark:text-gray-400">
                            Êtes-vous sûr de vouloir supprimer cette clinique ?</h3>
