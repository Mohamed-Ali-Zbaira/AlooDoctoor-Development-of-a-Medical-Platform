    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="/dashboardSuperAdmin" class="flex ml-2 md:mr-24">
                    <img src="https://res.cloudinary.com/dkrfmqbj1/image/upload/v1711831294/PFE/Aloodoctoor/AlooDoctoor_ozc70p.png"
                        class="h-8 mr-3" width="30%" height="40%" alt="AlooDoctoor Logo" />
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white"
                        style="color: #0e54b7;">AlooDoctoor</span>
                </a>
            ...
            <div class="flex items-center">
                ...
                <div>
                    <button type="button"
                        ...
                        <!-- Assuming you have a profile picture URL for the user -->
                ...
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                    ...
                    <ul class="py-1" role="none">
                        ...
                        <li>
                            <a href="/"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                                role="menuitem">AlooDoctoor</a>
                        </li>
                        <li>
                            <a href="/DashboardSuperAdmin/profile"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
...
@include('Inc.DashboardSuperAdmin.Sidebar')
