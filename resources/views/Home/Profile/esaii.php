                ...
                <div class="col-12 col-lg-9 col-xl-8 col-xxl-7">
                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <p>Je soussigné, {{ $rendezvous->medecin->full_name }},
                                    ...
                                    Ce rendez-vous est fixé pour une consultation médicale afin d'évaluer {{ $rendezvous->note }}.
                                    Cordialement,</p>
                                <br>
                    ...
                    <div class="row">
                        <div class="col-12 text-end">
                            ...
                            <button type="submit" onclick="window.print()" class="btn btn-primary mb-3 no-print">Download
                                rendez-vous</button>
                        </div>
                    </div>
                </div>
