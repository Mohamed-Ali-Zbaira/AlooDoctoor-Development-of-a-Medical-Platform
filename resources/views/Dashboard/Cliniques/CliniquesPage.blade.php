                ...
                <div
                    ...
                    <div class="w-full mb-1"><br>
                        <div class="mb-4">
                            ...
                            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">All Clinique
                            </h1>
                        </div>
                        <div class="sm:flex">
                            <div
                                ...
                                <form class="lg:pr-3" action="#" method="GET">
                                    ...
                                    <div class="relative mt-1 lg:w-64 xl:w-96">
                                        <input type="text" name="email" id="users-search"
                                            ...
                                            placeholder="Search for Clinique">
                                    </div>
                                </form>
                            ...
                            <div class="overflow-hidden shadow">
                                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                                    ...
                                    <tbody
                                        ...
                                        @foreach ($cliniques as $clinique => $C)
                                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                                    <img class="w-10 h-10 rounded-full" src="{{ asset($C->image) }}"
                                                ...
                                                <td class="p-4 space-x-2 whitespace-nowrap">
                                                    <button type="button"
                                                        data-modal-toggle="#edit-user-modal{{ $C->id }}"
                                                    ...
                                                    <!-- Delete button -->
                                                    <button type="button"
                                                        data-modal-toggle="#delete-user-modal{{ $C->id }}"
                                                        data-id="{{ $C->id }}"
                        ...
                        <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                ...
                                <div class="p-6 space-y-6">
                                    <form action="{{ route('cliniques.update', ['clinique' => $C->id]) }}"
                                        ...
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input type="text" name="ville"
                                                    value="{{ old('ville', $C->ville) }}" id="ville"
                                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            </div>
                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="email"
                                                ...
                                                <input type="email" name="email"
                                                    value="{{ old('email', $C->email) }}" id="email"
                                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            </div>
                                            <div class="col-span-6 sm:col-span-3">
                                                ...
                                                <input type="text" name="numero_telephone"
                                                    value="{{ old('numero_telephone', $C->numero_telephone) }}"
                                                    id="numero_telephone"
                                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            </div>
                                            <div class="col-span-6 sm:col-span-3">
                                                <label for="localisation_link"
                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lien
                                                    de localisation</label>
                                                <input type="text" name="localisation_link"
                                                    value="{{ old('localisation_link', $C->localisation_link) }}"
                                                    id="localisation_link"
                                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                            </div>
                                            <div class="col-span-6">
                                                ...
                                                <textarea name="description" id="description"
                                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">{{ old('description', $C->description) }}</textarea>
                                            </div>
                                            <div class="col-span-6">
                                                <label for="image"
                ...
                <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
                    ...
                    <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                            ...
                            <!-- Modal body -->
                            <div class="p-6 space-y-6">
                                <form action="{{ route('cliniques.store') }}" method="POST"
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                ...
                                <div class="p-6 pt-0 text-center">
                                    ...
                                    <h3 class="mt-5 mb-6 text-lg text-gray-500 dark:text-gray-400">
                                        ...
                                        delete this user?</h3>
                                    <a href="/dashboardMedecin/cliniques/{{ $C->id }}"
