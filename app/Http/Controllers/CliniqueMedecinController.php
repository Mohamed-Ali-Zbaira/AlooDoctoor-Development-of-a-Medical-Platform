...
class CliniqueMedecinController extends Controller
{
    public function index()
    {
        ...
        return view('Dashboard.Cliniques.CliniquesPage', compact('cliniques'));
    }
    ...
    public function edit(Clinique $clinique)
    {
        ...
        return view('Dashboard.Cliniques.EditCliniquePage', compact('clinique'));
    }
