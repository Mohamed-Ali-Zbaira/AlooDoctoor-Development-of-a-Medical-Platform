...
class OperationSuperAdminController extends Controller
{
    public function getAllOperations()
    {
        $operations = Operation::all();
        return view('DashboardSuperAdmin.Operation.ListesOperation', compact('operations'));
    }
    public function store(Request $request)
    {
        ...
        return redirect()->route('operationsDash.store')->with('success', 'Opération ajoutée avec succès.');
    }
    ...
    public function destroy($id)
    {
        ...
        // Redirigez l'utilisateur vers une page de confirmation avec un message de succès
        return redirect()->route('operationsDash.store')->with('success', 'Opération supprimée avec succès.');
    }
    public function update(Request $request, $id)
    {
        ...
        // Redirigez l'utilisateur vers une page de confirmation avec un message de succès
        return redirect()->route('operationsDash.store')->with('success', 'Opération mise à jour avec succès.');
    }
}